...
//         <h2 className="text-4xl lg:text-5xl font-bold text-yellow-300 mb-12">Skills & Tools</h2>
        
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {skillCategories.map((category, index) => (
//             <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
//               <h3 className="text-xl font-bold text-yellow-300 mb-4">{category.title}</h3>
//               <div className="flex flex-wrap gap-2">
//                 {category.skills.map((skill, idx) => (
//                   <span
//                     key={idx}
//                     className="bg-white/20 px-3 py-1 rounded-full text-sm font-medium hover:bg-yellow-300 hover:text-black transition-all duration-200"
//                   >
//                     {skill}
//                   </span>
//                 ))}
...
//         <div className="mt-12">
//           <h3 className="text-2xl font-bold text-yellow-300 mb-6">Education & Certifications</h3>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//             <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
//               <h4 className="text-lg font-bold text-yellow-300">Masters in Computer Science</h4>
//               <p className="text-white/90">University Of Central Missouri, Warrensburg, MO</p>
//             </div>
//             <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
//               <h4 className="text-lg font-bold text-yellow-300">Google Cloud Platform</h4>

...
//                 <a href="https://instagram.com" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
//                   <Instagram className="w-5 h-5 text-white" />
//                 </a>
//                 <a href="https://twitter.com" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
//                   <Twitter className="w-5 h-5 text-white" />
//                 </a>
//                 <a href="https://youtube.com" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
//                   <Youtube className="w-5 h-5 text-white" />
//                 </a>
//                 <a href="https://dribbble.com" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
//                   <Dribbble className="w-5 h-5 text-white" />
//                 </a>
//                 <a href="https://github.com/tejagelli" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
